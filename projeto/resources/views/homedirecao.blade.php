...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class  = "container">
			<form action=  "{{route('diretores.index')}}" method="get">
				<button type="submit" class="btn btn-lg btn-block btn-outline-primary">Direção</button><br>
			</form>
			<form action="{{route('docentes.index')}}">
				<button type="submit" class="btn btn-lg btn-block btn-outline-primary">Docente</button><br>
			</form>
			<form action="{{route('alunos.index')}}">
				<button type="submit" class="btn btn-lg btn-block btn-outline-primary">Aluno(a)</button><br>
			</form>
			<form action="#" method="post">
				<button type="submit" class="btn btn-lg btn-block btn-outline-primary">Turma</button><br>
			</form>
			<form action="{{route('disciplinas.index')}}">
				<button type="submit" class="btn btn-lg btn-block btn-outline-primary">Disciplina</button>
			</form>
		</div>
	</body>
	</html>
