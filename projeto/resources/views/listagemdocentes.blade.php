...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action=  "{{route('docentes.create')}}" method="get">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <tr>
            ...
            <td class ="organizar"><a href="{{route('docentes.edit',$docente->id)}}">Alterar</a><a href="{{route('docentes.show',$docente->id)}}">Exluir</a><td>
          </tr>
          @endforeach
          <tr>
          </tr>
