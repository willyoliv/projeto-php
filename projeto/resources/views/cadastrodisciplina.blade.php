...
<body>
  ...
  <div class="container">
    <form class="form" method="post" action="{{route('disciplinas.store')}}">
      ...
      <input type="date" class="form-control" min"1950-01-01" name="criacao" value="{{old('criacao')}}">
      <button type="submit" class="btn btn-lg btn-block btn-outline-primary">Criar Disciplina</button><br>
    </form>
  </div>
</body>
</html>
