...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action=  "{{route('diretores.create')}}" method="get">
      <button type="submit" class="btn btn-lg btn-block btn-outline-primary">Diretor +</button><br>
    </form>
    <div class  = "container">
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <tr>
            ...
            <td class ="organizar"><a href="{{route('diretores.edit',$diretor->id)}}">Alterar</a><a href="{{route('diretores.show',$diretor->id)}}">Exluir</a><td>
          </tr>
          @endforeach
          <tr>
          </tr>
