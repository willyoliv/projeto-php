...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form action=  "{{route('disciplinas.create')}}" method="get">
      <button type="submit" class="btn btn-lg btn-block btn-outline-primary">Disciplina +</button><br>
    </form>
    <hr>
    <div class  = "container">
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          <tr>
            ...
            <th class="text-primary">Data de criação</th>
            <th class="text-primary">Opções</th>
          </tr>
          @foreach ($disciplinas as $disciplina)
          <tr>
            <td>{{$disciplina->name}}</td>
            <td>{{$disciplina->criacao}}</td>
            <td class ="organizar"><a href="{{route('disciplinas.edit',$disciplina->id)}}">Alterar</a><a href="{{route('disciplinas.show',$disciplina->id)}}">Exluir</a><td>
          </tr>
          @endforeach
          <tr>
          </tr>
